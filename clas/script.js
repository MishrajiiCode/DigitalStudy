            ...
            button.addEventListener('click', () => {
                ...
                switch (option.toLowerCase()) {
                    ...
                    case "chemistry":
                        ...
                        break;
                    case "biology":
                        location.href = 'bio.html';  // Adjust the path if needed
                        break;
                    case "history":
                        location.href = 'history.html';  // Adjust the path if needed
                        break;
                    case "geography":
                         location.href = 'geography.html';  // Adjust the path if needed
                         break;
                    case "special pujas":
